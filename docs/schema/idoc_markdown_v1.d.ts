 ...
 */
export type Block = ProseBlock | VegaPluginBlock | VegaLitePluginBlock | TabulatorPluginBlock | MermaidPluginBlock | TreebarkPluginBlock | DropdownPluginBlock | SliderPluginBlock | NumberPluginBlock | CSSPluginBlock | CSVPluginBlock | PluginBlock;
/**
